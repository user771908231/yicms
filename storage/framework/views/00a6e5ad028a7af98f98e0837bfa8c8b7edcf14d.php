...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content">
            ...
            <form class="form-horizontal m-t-md" action="<?php echo e(route('roles.store')); ?>" method="post">
                <?php echo csrf_field(); ?>

                <input type="hidden"  name="u_id" value="<?php echo e($data); ?>">
                <div class="form-group">
                    <label class="col-sm-2 control-label">角色名称：</label>
                    <div class="input-group col-sm-2">
                        <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" required data-msg-required="请输入角色名称">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-3">
                        <textarea name="remark" class="form-control" rows="5" cols="20" data-msg-required="请输入角色描述"><?php echo e(old('remark')); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-1">
                        <input type="text" class="form-control" name="order" value="<?php echo e(old('order') ? old('order') : 255); ?>" required data-msg-required="请输入排序">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-1">
                        <select class="form-control" name="status">
                            ...
                            <option value="2" <?php if(old('status') == 2): ?> selected="selected" <?php endif; ?>>禁用</option>
                        </select>
